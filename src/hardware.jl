...
"""
manufacturer(x) = getter(x, "Manufacturer", String, x -> "")
...
"""
manufacturer_model_name(x) = getter(x, "ManufacturerModelName", String, x -> "")
...
"""
device_serial_number(x) = getter(x, "DeviceSerialNumber", String, x -> "00000")
...
"""
magnetic_field_strength(x) = getter(x, "MagneticFieldStrength", Float64, x -> 1.0)
...
"""
magnetic_field_strength!(x, val) = setter!(x, "MagneticFieldStrength", Float64, val)
...
"""
receiver_coil_name(x) = getter(x, "ReceiverCoilName", String, x -> "")
...
"""
receive_coil_active_elements(x) = getter(x, "ReceiveCoilActiveElements", String, x -> "")
...
"""
gradient_set_type(x) = getter(x, "GradientSetType", String, x -> "")
...
"""
matrix_coil_mode(x) = getter(x, "MatrixCoilMode", String, x -> "")
...
"""
coil_combination_method(x) =  getter(x, "CoilCombinationMethod", String, x -> "")
