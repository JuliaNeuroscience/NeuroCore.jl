...
composite instances.
"""
institution_name(x) = getter(x, "InstitutionName", String, i -> "")
...
"""
institution_address(x) = getter(x, "InstitutionAddress", String, i -> "")
...
the composite instances.
"""
institutional_department_name(x) = getter(x, "InstitutionalDepartmentName", String, i -> "")
...
"""
station_name(x) = getter(x, "StationName", String, i -> "")
